...
Usage:
    ...
    manage.py (pickup) [--model=<model>] [--js] [--chaos]
    manage.py (rampup) [--model=<model>] [--js] [--chaos]
...
from parts.Eyes import Eyes
from parts.Brains import Brains
from parts.Emil import Emil
from parts.Runner import Runner
from parts.Rampup import Rampup
...
def drive(cfg, model_path=None, use_joystick=False, use_chaos=False):
    ...
    # For Emily's setup we need these parameters
...
def pickup(cfg, model_path=None, use_joystick=False, use_chaos=False):
    ...
    # get eyes
#    model = Eyes('/home/pi/dev_car/models/lada_human.cfg', '/home/pi/dev_car/models/lada_human_7500.weights')
...
if __name__ == '__main__':
    ...
    if args['pickup']:
        pickup(cfg, model_path=args['--model'], use_joystick=args['--js'], use_chaos=args['--chaos'])

    if args['rampup']:
        rampup(cfg, model_path=args['--model'], use_joystick=args['--js'], use_chaos=args['--chaos'])
